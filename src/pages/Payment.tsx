...
const Payment = () => {
  ...
  const totalAmount = selectedItems.reduce((acc, item) => acc + (item.room && item.room[0] ? item.room[0].price : 0), 0);
      ...
      <Box width="100%" maxWidth="1240px" mx="auto" paddingTop="8rem">
        ...
        <Box 
          ...
          <Flex justifyContent="space-between" width="100%">
            <Text fontSize="3rem" fontWeight="900">총 결제금액</Text>
            <Text fontSize="3rem" color="price">{totalAmount.toLocaleString('ko-KR', { style: 'currency', currency: 'KRW' })}</Text>
          </Flex>
        </Box>
        {/* <CustomCheckbox
          item={}
